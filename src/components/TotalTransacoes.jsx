    ...
    return(
        <section className="flex gap-2 ">
            <Card className={"gap-0  p-2  flex-1 border-0 border-l-3 border-red-700 mb-3"}>
                ...
                <CardContent className={"text-red-500 font-bold px-1 text-lg"}>
                    <p>R$ {totalSaidas}</p>
                </CardContent>
            </Card>
            ...
            <Card className={"gap-0  p-2 flex-1 border-0 border-l-3 border-green-700 mb-3"}>
                ...
                <CardContent className={"text-green-600 font-bold px-1 text-lg"}>
                    <p>R$ {totalEntradas}</p>
                </CardContent>
            </Card>
            ...
            <Card className={"gap-0  p-2 flex-1 border-0 border-l-3 border-l-3 border-yellow-600 mb-3"}>
                ...
                <CardContent className={"text-yellow-600 font-bold px-1 text-lg"}>
